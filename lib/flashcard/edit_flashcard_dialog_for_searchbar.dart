...
class EditFlashcardDialogForSearchbar extends StatefulWidget {
  final String userId;
  final Folder folder;
  final Flashcard flashcard;

  const EditFlashcardDialogForSearchbar({super.key, required this.userId, required this.folder, required this.flashcard});

  @override
  _EditFlashcardDialogState createState() => _EditFlashcardDialogState();
}

class _EditFlashcardDialogState extends State<EditFlashcardDialogForSearchbar> {
